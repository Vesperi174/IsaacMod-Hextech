...
mod.HextechPool:Register(mod.ITEMS.MYSTICPUNCH, mod.HextechPool.PRISMATIC, 4)
mod.HextechPool:Register(mod.ITEMS.STATS, mod.HextechPool.SILVER, 1)
mod.HextechPool:Register(mod.ITEMS.SILVERSPOON, mod.HextechPool.SILVER, 1)
mod.HextechPool:Register(mod.ITEMS.TYPHOON, mod.HextechPool.SILVER, 1)
...
mod.HextechPool:Register(mod.ITEMS.BULLETHEAVEN, mod.HextechPool.PRISMATIC, 3)
mod.HextechPool:Register(mod.ITEMS.DRAWYOURSWORD, mod.HextechPool.PRISMATIC, 4)
