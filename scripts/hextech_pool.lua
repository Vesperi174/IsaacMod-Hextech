...
mod.HextechPool:Register(mod.ITEMS.TRANSMUTECHAOS, mod.HextechPool.PRISMATIC, 1)
mod.HextechPool:Register(mod.ITEMS.CELESTIALBODY, mod.HextechPool.GOLD, 1)
mod.HextechPool:Register(mod.ITEMS.JEWELEDGAUNTLET, mod.HextechPool.PRISMATIC, 1)
