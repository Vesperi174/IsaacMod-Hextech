...
mod.ITEMS.HITMEPULL = Isaac.GetItemIdByName("Hextech Hit Me and I'll Pull One for You")
mod.ITEMS.DODGEPROVOCATION = Isaac.GetItemIdByName("Hextech Dodge Provocation")
mod.ITEMS.BULLETHEAVEN = Isaac.GetItemIdByName("Hextech Bullet Heaven")
mod.ITEMS.DRAWYOURSWORD = Isaac.GetItemIdByName("Hextech Draw Your Sword")
