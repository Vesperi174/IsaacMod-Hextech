...
mod.ITEMS.ITSKILLINGTIME = Isaac.GetItemIdByName("Hextech It's Killing Time")
mod.ITEMS.NIGHTHUNT = Isaac.GetItemIdByName("Hextech Night Hunt")
mod.ITEMS.DEFT = Isaac.GetItemIdByName("Hextech Deft")
mod.ITEMS.DEMATERIALIZE = Isaac.GetItemIdByName("Hextech Dematerialize")
mod.ITEMS.SILVERSPOON = Isaac.GetItemIdByName("Hextech Silver Spoon")
mod.ITEMS.TYPHOON = Isaac.GetItemIdByName("Hextech Typhoon")
...
mod.ITEMS.CANTTOUCHTHIS = Isaac.GetItemIdByName("Hextech Can't Touch This")
mod.ITEMS.HOMEGUARD = Isaac.GetItemIdByName("Hextech Homeguard")
mod.ITEMS.PLAGUEBEARER = Isaac.GetItemIdByName("Hextech Plaguebearer")
mod.ITEMS.MAGICMISSILE = Isaac.GetItemIdByName("Hextech Magic Missile")
mod.ITEMS.DOUBLETAP = Isaac.GetItemIdByName("Hextech Double Tap")
mod.ITEMS.AUGMENT404 = Isaac.GetItemIdByName("Hextech Augment 404")
mod.ITEMS.AUGMENT405 = Isaac.GetItemIdByName("Hextech Augment 405")
